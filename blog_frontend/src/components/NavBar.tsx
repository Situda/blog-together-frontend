    ...
    return (
        <div className='container px-4 mx-auto flex justify-between py-4 '>
            ...
            <div className="header_right flex  justify-between items-center gap-2">
                <SearchBox />
                <button className="p-2 rounded-full hover:bg-slate-200 transition-colors duration-300 cursor-pointer">
                ...
                <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full  w-10 bg-[url(https://p4.music.126.net/-kiI3iZ0-iJO-6-oPgPc-g==/109951166073015392.jpg)]"></div>
            </div>
